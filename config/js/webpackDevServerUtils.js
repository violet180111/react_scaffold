...
function printInstructions(logInfo = {}) {
  ...
  const getUrl = (info) => `${protocol}${info}:${port}`;

  console.log(`You can now view ${chalk.bold(appName)} in the browser.`);
  console.log();
  console.log(`  ${chalk.bold('Local:')}            ${getUrl(host)}`);
  console.log(`  ${chalk.bold('On Your Network:')}  ${getUrl(localIPv4)}`);
  localIPv6 && console.log(`  ${chalk.bold('On Your Network:')}  ${getUrl(localIPv6)}`);
  console.log();
